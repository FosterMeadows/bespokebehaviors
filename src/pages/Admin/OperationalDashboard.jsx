...
export default function OperationalDashboard() {
  ...
  if (loading) {
    return <div className="rounded-xl border border-slate-200 bg-white px-5 py-12 text-center text-sm text-slate-600">Loading operational healthâ€¦</div>;
  }
    ...
    <div className="space-y-5">
      ...
      <div className="grid gap-3 sm:grid-cols-2 xl:grid-cols-3">
        ...
        <MetricCard
          ...
          label="Home Contacts"
          value={canViewHomeContacts ? metrics.pendingContacts : "â€”"}
