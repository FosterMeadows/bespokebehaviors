...
- **Structure:**
  ...
  - `src/services/`: Data/service modules (plans, academic, sharing)
...
- **Service Modules:** API/data logic is separated in `src/services/` (e.g., `plans.js`, `academic.js`). Import these for data operations.
